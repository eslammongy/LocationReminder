...
public class FragmentSaveReminderBindingImpl extends FragmentSaveReminderBinding  {
    ...
    private androidx.databinding.InverseBindingListener reminderDescriptionandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.eslammongy.locationreminder.locationreminders.savereminder.SaveReminderViewModel viewModel = mViewModel;
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.eslammongy.locationreminder.locationreminders.savereminder.SaveReminderViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.eslammongy.locationreminder.locationreminders.savereminder.SaveReminderViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x32L) != 0) {
            ...
            com.eslammongy.locationreminder.utils.BindingAdapters.setFadeVisible(this.progressBar, ViewModelShowLoadingBooleanValue1);
            com.eslammongy.locationreminder.utils.BindingAdapters.setFadeVisible(this.saveReminder, viewModelShowLoadingBooleanValue);
        }
        if ((dirtyFlags & 0x31L) != 0) {
            // api target 1
